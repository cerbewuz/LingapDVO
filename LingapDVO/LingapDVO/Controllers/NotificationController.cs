...
public class NotificationsController : Controller
{
    ...
    [HttpGet]
    public JsonResult GetAllUserNotifications()
    {
        var userIdString = HttpContext.Session.GetString("UserId");
        ...
        try
        {
            ...
            // Get ALL form submissions (no date limit for "View All" page)
        ...
        {
            _logger.LogError(ex, "Error occurred while loading all notifications for user");
